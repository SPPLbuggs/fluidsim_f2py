...
def plot_phi(z,r,t,n,nt):
    ...
    fig,axes = plt.subplots(1,2,sharey=True,figsize=[9,3.7])
    (ax1,ax2) = axes
    vmin = nt.min()
    vmax = nt.max()
    ...
    plt.subplots_adjust(left=0.08,right=1.05,top=0.85,bottom=0.16,wspace=0.125)
    ...
    plt.subplots_adjust(left=0.12,right=0.96,bottom=0.17,top=0.9)
